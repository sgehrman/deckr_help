...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get activatingALicenseWillUpdateARecord =>
      '激活许可证将更新我们服务器上的记录，表明该密钥已安装在您的计算机上。';

  @override
  String get aLicenseKeyMustBeActivatedOnYourMachine =>
      '必须在机器上激活许可证密钥，以显示您已购买 Deckr。';
  ...
  String get byDefaultYouAreGiven3Activations =>
      '默认情况下，每次购买可激活 3 台电脑。您最多可以激活 3 台电脑。如果您停止使用其中一台电脑，可以将其停用。';

  @override
  String get clickOnThatIconAndAMenuAppears =>
      '点击该图标后会出现一个菜单。选择 \"关于 Deckr \"菜单项。';

  @override
  String get clickTheLinkOnTheHomePageAndClickInstall =>
      '点击主页上的链接，然后点击 \"安装扩展\"。安装完成后，运行桌面应用程序并打开浏览器窗口，新建一个标签页，Deckr 就会显示出来。';
  ...
  String get deckrHasTwoPartsABrowserPlugin =>
      'Deckr 包括两个部分。一个浏览器插件（Chrome 或 Firefox）和一个桌面应用程序（Mac/Win/Linux）。';

  @override
  String get deckrProvidesANewWayToShareAndDiscover =>
      'Deckr 提供了一种在线分享和发现精彩内容的新方式。';

  @override
  String get discovingGreatContentIsUpToUsPeople =>
      '发现精彩内容取决于我们自己。人们需要发挥主观能动性，共同发掘精彩内容，而不是依赖 \"大科技\"。';
  ...
  String get inThisWindowFindTheCheckboxLabeled =>
      '在该窗口中找到标有 \"启动时启动 \"的复选框，现在它将在重启后启动。  这项功能非常方便，因此 Deckr 可以随时运行，随时可用。';

  @override
  String get justEnterTheLicenseKeyOnAnother =>
      '只需在另一台电脑上输入许可证密钥即可。默认情况下，您可以激活 3 个许可证。这将允许您在笔记本电脑、台式机和电视上安装。';

  @override
  String get makeANewTabToBringUpDeckrAndLook =>
      '新建一个标签页，打开 Deckr，在左侧查看打开的标签页列表。将标签拖动到中间一列的书签甲板上。';
  ...
  String get noneOfYourBookmarksOrPersonalInformation =>
      '您的任何书签或个人信息都不会上传到我们的云端，除非您选择备份甲板。';

  @override
  String get onceYouSetTheZoomLevelItWi =>
      '一旦设置了缩放级别，该设置将只用于 Deckr 的页面，而不会影响其他页面。';

  @override
  String get onLinuxClickTheLinkOnTheHomePage =>
      '在 Linux 上，点击主页上的链接，即可转到 Flatpak.org 上的安装说明。';

  @override
  String get onMacosDownloadTheDmgUsing =>
      '在 MacOS 上，使用主页上的链接下载 dmg。打开 DMG，将 Deckr 应用程序拖到 /Applications 文件夹。';

  @override
  String get onWindowsDownloadTheInstallerUsing =>
      '在 Windows 系统中，使用主页上的链接下载安装程序，运行安装程序。';
  ...
  String get theDesktopActsAsALocalWebserver =>
      '桌面充当本地网络服务器，为浏览器插件提供数据。它在后台悄悄运行。这样做既能提高速度，又能保护隐私。您的数据存储在本地，而不是云端。';

  @override
  String get theExtensionIsListedOnTheChrome =>
      '该扩展已在 Chrome 和 Firefox 应用程序商店中列出。';

  @override
  String get theProblemIsDiscoveryNowDaysMost =>
      '问题在于发现。如今，大多数人只关注 Twitter、Facebook 和 YouTube，并依靠谷歌搜索来寻找新的信息来源。但这已经行不通了';
  ...
  String get thisServesThePurposeOfLettingYouKnowIt =>
      '这样做的目的是让你知道它正在运行，它还有一个退出菜单项，以便你在需要时退出桌面应用程序。';

  @override
  String get thisWillSelectTheDeckrTabOrCreateANewDeckrTab =>
      '这将选择 Deckr 标签，或创建一个新的 Deckr 标签。  如果你想回到 Deckr 而又不想在标签栏中找到它，那么这个功能就很不错。';

  @override
  String get toRequestARefundBeforeYouRequest =>
      '申请退款。在您申请退款之前，我们很乐意听听您不满意的原因。也许我们可以在下一次更新中解决这个问题。';
  ...
  String get weTriedToMakeEverythingAsSimpleAsPossible =>
      '我们努力让一切尽可能简单，但如果您感到困惑，请不要担心。如果您需要帮助，请联系我们的';
  ...
  String get whenTheDeckrDesktopAppIsRun =>
      'Deckr 桌面应用程序运行时，会在菜单栏（Windows 的任务栏）右上方显示一个蓝色图标。';

  @override
  String get whenTheDeckrDesktopAppIsRunning =>
      '当 Deckr 桌面应用程序运行时，它会在菜单栏（Windows 的任务栏）中添加一个项目。';

  @override
  String get whenYouPurchaseDeckrYouAreSentALicenseKey =>
      '购买 Deckr 时，您将收到一个许可证密钥。密钥是一个唯一的字符串，代表您购买的产品。';

  @override
  String get whenYouReceiveYourKeyYouPasteIntoThePurchase =>
      '收到密钥后，将其粘贴到 Deckr 的购买对话框中并激活。';
  ...
  String get willAddTheCurrentTabYouAreViewingIntoTheInbox =>
      '将把您正在查看的当前标签页添加到收件箱中。如果你想保存这个链接，但现在又不想处理它，这就很有用了。有时间的话，你可以把它从收件箱拖到甲板上。';
  ...
  String get youCanAlsoBackupYourBookmarksTo =>
      '您还可以将书签备份到 Deckr 云端，这需要一个账户来保密';

  @override
  String get youCanAlsoTypeCmdShiftKToAddThe =>
      '您还可以输入 Cmd-Shift-K 将当前标签页书签添加到 Deckr 屏幕右上方的 \"稍后阅读 \"框中。';
  ...
  String get youMayHaveNoticedThatSearchingWithGoogleOr =>
      '您可能已经注意到，现在使用 Google 或 YouTube 搜索的结果并不理想。';

  @override
  String get youtubeForExampleHasSomeGreatContent =>
      '例如，YouTube 上就有一些很棒的内容，但要找到这些内容几乎是不可能的。通常，找到好的视频要靠运气。或者从几页结果中筛选出好的内容。';
}
